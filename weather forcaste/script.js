...
let weather = {
 ...
 displayWeather: function (data) {
  ...
  document.body.style.backgroundIgmage = "url('https://source.unsplash.com/1600x900/?" + name + "')";
 },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const weatherDescription = document.querySelector('.description').textContent.toLowerCase();
